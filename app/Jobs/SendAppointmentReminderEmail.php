    ...
    public function handle()
    {
        ...
        $message = "
            <div style='color: #333;'>
                ...
                <p style='font-size: 16px;'>This is a reminder for your upcoming appointment with <strong>{$doctorName}</strong> today. Please find the details of your appointment below:</p>
